"""Сделайть таблицу для подсчёта личных расходов со следующими полям:  id, назначение, сумма, время"""
"""Создайте таблицу для личного учёта бюджета. Напишите несколько запросов, для добавления данных о расходах"""
